package one.dio.beerstock.beerstock.config;
...
/*    private static final String BASE_PACKAGE = "one.digitalinnovation.beerstock.controller";
    ...
    private static final String BASE_PACKAGE = "one.dio.beerstock.controller";
    private static final String API_TITLE = "Beer Stock API";
    private static final String API_DESCRIPTION = "REST API for beer stock management";
    private static final String CONTACT_NAME = "Thiago Souza";
    private static final String CONTACT_GITHUB = "https://gtihub.com/Thiagoss89";
    private static final String CONTACT_EMAIL = "t.silvas@outlook.com";
